        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {isPolling ? (
            ...
            <div>
              ...
              <p>Progress: {aiResult.progress}%</p>
              {aiResult.result?.images && (
                <div className="grid grid-cols-2 gap-4 mt-4">
                  {aiResult.result.images.map((file, index: number) => (
                    <div key={index} className="border rounded p-2">
                      <Image src={file.thumbnail_url} alt={`Result ${index + 1}`} width={400} height={400} className="w-full h-auto" />
                      <button
